 ...
 <div class="container">
		...
		<br><br>
			<div style="margin-top:10px;margin-bottom:50px;margin-left:100px;margin-right:150px">
				<h2 align="center" style="color:#990099;font-family:Cambria;font-size:25px;">View Upload File by Data Owner</h2> 
...
<div style="margin-top:0px;margin-bottom:0px;">
   <div style="width:8000px; height:300px; overflow:auto;">
   <table cellspacing="1200" cellpadding="50" border="5" width="800px" align="center" >
...
<% 
		...
		dao.makeConnection();
		ResultSet rs=dao.selectPerticularDataOwner(username);
						while(rs.next())
            			 {
        		%>
       ...
       <tr>
        <TD align="center" style="color:black">  <%= rs.getString(1) %> </TD>
               		...
               		<%--  <TD style="color:black"><a href="UploadServlet?id=<%= rs.getString(1)%>">Delete</a></td>  --%>
