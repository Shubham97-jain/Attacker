...
<div class="top_banner two">
			<div class="container">
			       <div class="sub-hd-inner">
						<center><h3 class="tittle">Data  <span>User</span> <span>Profile</span></h3></center>
        			...
        			//	 ResultSet rs=userService.selectUser(username);
              		...
              		//	ResultSet rs=dao.selectUser(String username);
                        ...
                        <table class="table table-bordered" style="align:center;">
                       		...
                       		<tr><th><h4>Contact</h4></th><td style="padding-left: 20px"> <%=rs.getString(7) %> </td></tr>
                       	     <tr><th><h4>DOB</h4></th><td style="padding-left: 20px"> <%=rs.getString(6) %> </td></tr>
