...
<nav class="navbar navbar-default navbar-fixed-top" data-aos="flip-up">
    <div class="container">
        ...
        <div class="navbar-header">
			...
			<a class="navbar-brand" href="index.jsp"><h1>Search</h1></a>
        </div>
...
<div class="container">
				 <div id="loginbox" style="margin-top:150px;margin-bottom:150px;" class="mainbox col-md-3 col-md-offset-2 col-sm-6 col-sm-offset-1">
					<div class = "panel panel-primary">
   						<div class = "panel-heading">
     						 <h3 class = "panel-title" align="center">Enter OTP</h3>
   						</div>
      ...
      -->       					<input type="submit" style="margin-left:100px"name="submit" value="OTPSubmit">
