...
<h1 class="w3ls">Sign Up</h1>
	<div class="content-agileits">
		<form action="UserRegistration" method="post" data-toggle="validator" role="form">
			...
			<div class="form-group agileinfo wthree w3-agileits agile">
				...
				<input type="date" name="dob" id="dob" class="form-control" data-error="invalid date" required>
				<div class="help-block with-errors"></div>
	           ...
	           <div class="form-group agileinfo wthree w3-agileits agile">
	                   <div class="col-md-10">	
                            <label for="Gender" class="control-label">Gender</label></b>
                                    <input type="radio" name="gender"  value="Male"> <label for="dob" class="control-label">Male</label>
                                   <input type="radio" name="gender"  value="Female">  <label for="dob" class="control-label">Female</label>
