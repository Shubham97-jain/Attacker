		...
		<div class="items-group">
			<div class="item agileits-w3layouts">
					...
					<div class="login-form loginw3-agile"> 
						<div class="agile-row">
							...
							<div class="login-agileits-bottom wthree"> 
								<h6><a href="dataownerforgotpassword.jsp">Forgot password?</a></h6>
							</div> 
							
							<div class="login-agileits-bottom wthree"> 
								<h6><a href="dataownerregistration.jsp">Registration</a></h6>
							</div> 
				...
				<div class="w3lsfooteragileits">
					<p>Attack prevention and detection using Access Control Encrypted Cloud Storage</p>				</div> 
			</div>   
		</div>
	</div>	 
	<!-- //main --> 
