   						...
   						<div class = "panel-heading">
     						 <h3 class = "panel-title" align="center">Enter Verify Email</h3>
   							...
   							<div class = "panel-body">
       							 <form class="form-signin" name="login" action="DataOwnerLogin" method="post">
                							<span id="reauth-email" class="reauth-email"></span>
                								<div class="form-group"><center>
        EmailID:<input type="text" style="width:60%"  name="name" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" placeholder="Emailid" required/>
                          
                 								</div>
              						
								               
                                               <!--  <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="submit" value="SignIn">Sign in</button>
      -->       				<center>	<input type="submit" name="submit" style="width:120px;height: 40px;"  value="Forgot" > </center>
