    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav slide-nav">
				...
				<li class="active current"><a href="#">File details</a></li>
...
<%
	...
	String keywordsecretkey=(String)session.getAttribute("keywordsecretkey");
...
<div class="top_banner two">
			<div class="container">
			       <div class="sub-hd-inner">
						<center><h3 class="tittle">Data  <span>User</span> <span>Email</span></h3></center>
...
<div class="container">
				 <div id="loginbox" style="margin-top:150px;margin-bottom:150px;" class="mainbox col-md-5 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class = "panel panel-primary">
   						<div class = "panel-heading">
     						 <h3 class = "panel-title" align="center">Enter Verify Email</h3>
   						</div>
   							<div class = "panel-body">
       							 <form class="form-signin" name="login" action="ValidUser" method="post">
                							<span id="reauth-email" class="reauth-email"></span>
                								<div class="form-group"><center>
        EmailID:<input type="text" style="width:80%"  name="name" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" placeholder="Emailid" required/>
                          
                 								</div>
              						
								               
                                               <!--  <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="submit" value="SignIn">Sign in</button>
      -->       				<center>	<input type="submit" name="submit" style="width:120px;height: 40px;"  value="Valid" > </center>
